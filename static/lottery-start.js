...
var ani = function(left, easing, duration){
  ...
  var timer = setInterval(function(){
    ...
    $pool.append(dom);
    $pool.find("#avatar_"+item.id+"").velocity({top: "-200px"}, {
      duration: duration,
      complete: function () {
        _employeeList.push({
          id: $(this).data('id'),
  ...
  }, duration/10, 'ease-in-out')
};

var startScroll = function(){
  var durationQueue = [8000, 1800, 2000,4000, 4000, 5000, 6000, 7000];
  var leftQueue = [114, 114+400*1+10, 114+400*2+20, 114+400*3+40, 114+400*4+50, 114+200*5+70,114+200*6+80,114+200*7+100];
